...
export default function Footer() {
  return <footer className="site-footer"><div className="site-container">
    <div className="footer-grid"><div><Logo /><p>Enough to eat.<br />A chance to thrive.</p><span className="text-base">Food · Clothing · Education</span></div>
    ...
    <div><h2>Talk to the team</h2><p>Chennai, Tamil Nadu, India</p><a className="break-all" href="mailto:alwynjosephp@gmail.com">alwynjosephp@gmail.com <ArrowUpRight size={14} /></a><a href="tel:+919884662222">+91 98846 62222</a><p className="text-base">Questions before donating? Please reach out.</p></div></div>
